...
例如，`accounting-app` 的 `frontend-dev-01` 使用岗位 `developer`，需要 `software-engineering.md`、`frontend-development.md` 和 `backend-development.md` 三份知识文档。这些文件都是可直接读取的普通 Markdown 资料。
