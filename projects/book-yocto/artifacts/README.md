...
| A-004 | [体例约定](A-004-体例约定草案.md) | writer | T-005、T-013 | 0.5 | in_review | v0.4 为已批准基线；v0.5 按 T-011 U-10/U-12 与 T-013 新增硬件型号、粗体/反引号边界及等宽文本规则，待 project-manager 核对与用户确认 |
